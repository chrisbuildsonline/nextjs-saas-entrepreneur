...
const testimonials = [
  {
    ...
    content: "This boilerplate saved me 3 months of development time. I was able to launch my SaaS in just 2 weeks!",
    rating: 5,
  },
  {
    ...
    content: "The code quality is exceptional. Everything is well-documented and production-ready out of the box.",
    rating: 5,
  },
  {
    name: "Emily Johnson",
    ...
    content: "Best investment I made for my startup. The Stripe integration alone is worth the price.",
    rating: 5,
  },
]
    ...
    <section id="testimonials" className="py-20 px-4 bg-white dark:bg-slate-900">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">What Entrepreneurs Say</h2>
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Join hundreds of successful founders who launched with our boilerplate
          </p>
        </div>
